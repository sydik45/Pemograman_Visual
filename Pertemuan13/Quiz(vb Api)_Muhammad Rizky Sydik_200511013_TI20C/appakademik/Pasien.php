...
class Pasien 
{
    ...
    {
        $query = "UPDATE $this->table SET nrp = '$this->nrp', nama = '$this->nama', jk = '$this->jk', tgl_lahir = '$this->tgl_lahir', alamat = '$this->alamat', kota = '$this->kota' WHERE id = $id";
        $this->db->query($query);
        return $this->db->affected_rows();
    }
    public function update_by_nrp($nrp): int
    {
        $query = "UPDATE $this->table SET nrp = '$this->nrp', nama = '$this->nama', jk = '$this->jk', tgl_lahir = '$this->tgl_lahir', alamat = '$this->alamat', kota = '$this->kota' WHERE nrp = '$nrp'";
        $this->db->query($query);
        return $this->db->affected_rows();
    }
